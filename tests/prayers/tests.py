...
from apps.prayer.models import Day, City, Prayer, PrayerAtUserGroup, PrayerAtUser
from apps.prayer.schemas import PRAYER_NAMES
from apps.prayer.service import set_city_to_subscriber_by_location, set_city_to_subscriber, get_now_prayer, get_unread_prayers_by_chat_id, generate_prayer_at_user
